...
namespace MetricsManager.Controllers
{
    ...
    public class DotNetMetricsController : ControllerBase
    {
        ...
        public DotNetMetricsController(ILogger<DotNetMetricsController> logger, IMapper mapper, IMetricsAgentClient metricsAgentClient)
        {
            _logger = logger;
            _mapper = mapper;
        ...
        public IActionResult GetMetricsFromCluster([FromRoute] TimeSpan fromTime, [FromRoute] TimeSpan toTime)
        {
            ...
            var response = _metricsAgentClient.GetAllDotNetMetrics(new AllDotNetMetricsRequest(fromTime, toTime));
            if (response is null)
            {
                return Problem();
            }
