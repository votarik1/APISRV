...
namespace MetricsManager.Controllers
{
    ...
    public class RamMetricsController : ControllerBase
    {
        ...
        public RamMetricsController(ILogger<RamMetricsController> logger, IMapper mapper, IMetricsAgentClient metricsAgentClient)
        {
            _logger = logger;
            _mapper = mapper;
        ...
        public IActionResult GetMetricsFromCluster([FromRoute] TimeSpan fromTime, [FromRoute] TimeSpan toTime)
        {
            ...
            var response = _metricsAgentClient.GetAllRamMetrics(new AllRamMetricsRequest(fromTime, toTime));
            if (response is null)
            {
                return Problem();
            }
